/**
  ...
  */
  ...
  function cryptobox_custom(url, paid, path, ext, redirect,token)
  {
    ...
    cryptobox_callout = function () 
    {
      ...
      .done(function( data ) 
      {
        ...
        if (data.status == "payment_received")
        {
          ...
          // if (!paid) $.post( path+"/images/gourl/cryptobox.callback.php", data )
          ...
          if (redirect) setTimeout(function() { window.location = redirect; }, 100);
        }
        ...
        {               
          ...
          {
            setTimeout(cryptobox_callout, 3000);
          }
        }
      });
    }
